...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/breadman123456/Incognito-old/tree/main)
...
```sh
git clone https://github.com/Titanium-Network/Incognito
cd Incognito
npm install
npm start
```
